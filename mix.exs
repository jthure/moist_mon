defmodule MoistMon.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      {:muontrap, "~> 0.4"},
      {:my_sensors_mysgw, git: "https://github.com/jthure/my_sensors_mysgw.git", branch: "master", submodules: true}
